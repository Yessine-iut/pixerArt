...
let pixelBoard2 = new PixelBoard({ statut: false, dateCreation: convertDate(new Date(2022, 06, 01)), dateFin: convertDate(new Date(2022, 12, 01)),taille: {"width": 50,"height": 50},auteur: "Yessine",mode: "competitif",delai: 10,titre: "Title2",pixels: [{position: {x: 90,y: 20},couleur: "dark",auteur: "Yessine"}]});
